...
public class AVRAssemblyProgramElement extends AssemblyProgramElement {

    public AVRAssemblyProgramElement(AssemblyTranslation translation, ProgramElement procedure) {
        super(procedure);
