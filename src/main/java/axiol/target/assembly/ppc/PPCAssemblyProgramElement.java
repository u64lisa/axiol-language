...
public class PPCAssemblyProgramElement extends AssemblyProgramElement {

    public PPCAssemblyProgramElement(AssemblyTranslation translation, ProgramElement procedure) {
        super(procedure);
