...
public class AARCHAssemblyProgramElement extends AssemblyProgramElement {

    public AARCHAssemblyProgramElement(AssemblyTranslation translation, ProgramElement procedure) {
        super(procedure);
