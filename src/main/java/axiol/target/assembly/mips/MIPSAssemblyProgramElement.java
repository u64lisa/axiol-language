...
public class MIPSAssemblyProgramElement extends AssemblyProgramElement {

    public MIPSAssemblyProgramElement(AssemblyTranslation translation, ProgramElement procedure) {
        super(procedure);
