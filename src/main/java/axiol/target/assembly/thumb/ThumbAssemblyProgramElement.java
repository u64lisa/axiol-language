...
public class ThumbAssemblyProgramElement extends AssemblyProgramElement {

    public ThumbAssemblyProgramElement(AssemblyTranslation translation, ProgramElement procedure) {
        super(procedure);
